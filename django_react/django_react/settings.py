...
# Folder where global project stuff is:
...
SECRET_KEY = '4%8m8xy1cz)75+91=e$acw6az+(b31w56=js%e*377owa$dl%i'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            normpath(join(PROJECT_PATH, 'react/templates')),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = (
    join(PROJECT_PATH, 'react/static'),
)
